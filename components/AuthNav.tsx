...
const authLinkClasses = `hidden whitespace-nowrap rounded-lg px-0.5 py-1.5 text-sm font-medium text-gray-600 transition-colors duration-150 ease-out-expo hover:text-ink ${focusRingClasses} dark:text-gray-400 dark:hover:text-gray-100 xl:block`
