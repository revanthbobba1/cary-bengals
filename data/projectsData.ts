const projectsData = [
  {
    ...
    imgSrc: '/static/images/week-four-press.png',
    href: 'https://youtu.be/RjeOb-S3xX0?si=_71DY-NszkRVShya',
  },
  {
    title: 'Cary Bengals Week 3 Press Conference',
    ...
    imgSrc: '/static/images/week-three-press.png',
    href: 'https://youtu.be/Y6mEg2kepBw?si=Km5ro6Uo4wU2i6ZZ',
  },
  {
    title: 'Cary Bengals Week 2 Press Conference',
    description: `Cary Bengals week two press conference featuring the trophy presentation for Cookin' It Up GM Sparsh Patel and 
    interviews from Team ETERNAL PAIN GM Amogh Natu, Team Drako GM Carter Bilbro, and Disney Pixar Baddies GM Sam Nangali.`,
    imgSrc: '/static/images/mickey.png',
    href: 'https://youtu.be/eh3mAfQpIJc?si=bh7LrEL95pzPb3z4',
  },
  {
    ...
    imgSrc: '/static/images/more_mickey.png',
